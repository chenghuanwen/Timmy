...
public final class HttpManagerImpl implements HttpManager {
    ...
    @Override
    public <T> Callback.Cancelable post(RequestParams entity, CommonCallback<T> callback) {
    ...
    @Override
    public <T> Callback.Cancelable request(HttpMethod method, RequestParams entity, CommonCallback<T> callback) {
        entity.setMethod(method);
        Callback.Cancelable cancelable = null;
        if (callback instanceof Callback.Cancelable) {
            cancelable = (Callback.Cancelable) callback;
