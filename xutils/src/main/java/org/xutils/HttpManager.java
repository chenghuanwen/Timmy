...
public interface HttpManager {
     ...
     * @return
     */
    <T> Callback.Cancelable get(RequestParams entity,org.xutils.common.Callback.CommonCallback<T> callback);
     ...
     * @return
     */
    <T> Callback.Cancelable post(RequestParams entity, CommonCallback<T> callback);
     ...
     * @return
     */
    <T> Callback.Cancelable request(HttpMethod method, RequestParams entity, org.xutils.common.Callback.CommonCallback<T> callback);
     ...
     * @return
     */
    <T> Callback.Cancelable request(HttpMethod method, RequestParams entity, CommonCallback<T> callback);
